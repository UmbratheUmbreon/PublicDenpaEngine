...
class Song
{
	...
	public var autoZooms:Bool = true;
	public var dangerMiss:Bool = false;
	public var crits:Bool = false;
	public var allowBot:Bool = true;
	public var allowGhostTapping:Bool = true;
	public var beatDrain:Bool = false;
	public var enablePlayer4:Bool = true;

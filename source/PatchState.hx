...
class PatchState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['0.4.0b',		'eidol',		'A-Sum Graphics, A-Fullscreen Toggle, A-Splash Screen, A-UI Skins, A-The Rest of Sound Test, A-Healthbar Offsets, A-Reset Settings Hotkey, A-New Events to Mess with the Cameras, A-Colour Tweens to Chart Editor, F-Countdown Sprite Sizings, F-Chara Editor Get Dom Colour, F-MOST setDefaultDrawTarget Warnings, F-Sound Test not Keeping Track of Yer Song and Album, RFV-0.4.0b',							'wait till next update',	'998844'],
			['0.4.0',		'eidol',		'Im not writing this, RFV-0.4.0',							'wait till next update',	'998844'],
			['0.3.1',		'fidol',		'A-Beatmap (Ehhh...), A-Crit Mechanic, A-Song Credits Card, A-Rating Saving/Display in Freeplay, A-Cool First Time Opening Main Menu Intro, U-GF and Senpai Icons, U-Character Editor to Have Nearly Identical Stage Replications, U-Made Sarv Score Display More Accurate, U-Ratings Display, U-Max Combo to 999,999, F-Lacking Pixel Perfect and WTF Graphics, F-Combo Graphics, U-Sick Graphic, F-BPM on Title Screen, F-Title Screen Logo Placement, F-GF Not Crying When You MISS a Note, F-Botplay not Always Getting Perfects, R-Leftover Easy Difficulty Stuff, RFV-0.3.1',							'wait till next update',	'B60000'],
			['0.3.0b',		'almighty',		'A-Music to The Editors, A-Stage Changer to Character Editor, O-More Stuff, F-Health Icon Cut Offs, U-Discord RPC, U-Sarvente Lucifer, U-Character Editor Layout, U-Chart Editor Layout, RFV-0.3.0b',							'wait till next update',	'FFFFFF'],
			['0.3.0',		'almighty',		'A-Camera Movement on Note Hit, A-Cool Score Display Options, A-BM Showcase Song/Stage, A-Perfect and WTF Ratings, A-CrossFade Settings, A-Ratings Display, C-Ratings, F-CROSSFADE(FRFR)!!!, F-Pixel Notes, O-A Lot of Stuff, RFV-0.3.0',							'https://github.com/UmbratheUmbreon/DenpaFunkinSource-Denpa-Engine/commit/74167d07955d4e59fb3217e62bd6d8fc0556ed9b',	'FFFFFF'],
			['0.2.4b',		'amogus',		'A-Dual/Triple Colour HP Bars, A-Angle Snap Icon Animation, R-Aggro Swing, F-Crossfade stuff, RFV-0.2.4b',							'https://github.com/UmbratheUmbreon/DenpaFunkinSource-Denpa-Engine/commit/379e7f8ff93db9ba46f9402b71dfc19c3bf9f72d',	'FFFFFF'],
			['0.2.4',		'amogus',		'A-A Boatload Of Options To Toggle, F-A Lot Of Multikey Related Errors, RFV-0.2.4',							'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/ecd982babbd4ab394426a22c67f58d8cb06fbcac',	'FFFFFF'],
			['0.2.3c',		'life',		'A-Insanity Difficulty, A-Multikey Support, C-Botplay Text To "AUTO", U-Patch Note Menu To Be More Descriptive, F-Not Being Able To Enter In Text Boxes, RFV-0.2.3c',							'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/57eb62df518a79c051aabd8a6094bde39348a170',	'F499C2'],
			['0.2.3b',		'life',		'U-Credits, U-Secret Song Functionality, RFV-0.2.3b',							'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/7a21260bca58f3a4f47cf23c2f88eaf1f695baa3',	'F499C2'],
			['0.2.3',		'life',		'A-This Menu, A-BG Scroll In Master Editor, F-BG Scroll Lag, F-BG Scroll Size, RFV-0.2.3',							'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/3ab55597186e0be2c002b08bbd10154237fb3d42',	'F499C2'],
			['0.2.2',		'stamina',		'U-Credits, U-Disruption, U-CF Color, F-CrossFade, A-CrossFade Notes, A-Icon Flinch, C-OutdatedState, RFV-0.2.2',						'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/1305277c8426c1cb43606fd183cb43413f3d854b',		'8DC642'],
			['0.2.1c',		'speed',			'A-Random Mode, F-SecVoices in Chart, A-Chart Effects, M-FreePlay Scroll not C Colors, M-Options Menu Scroll, RFV-0.2.1c',					'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/a85c17c48328bc9ad619231a172ea0353537109d',			'FFDD66'],
			['0.2.1b',		'speed',			'F-FreePlay Scroll, RFV-0.2.1b',					'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/07e45c5ae469462f344511ca5e5bb26afcd22b5b',			'FFDD66'],
			['0.2.1',		'speed',			'N-Combo Graphics, Cool Menu Stuff, RFV-0.2.1',					'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/07057074db7c93662eaf992cd2f224a4aec1f672',			'FFDD66'],
			['0.2.0c',		'power',			'A-Character Select Song, A-Title Song, C-Title BPM, RFV-0.2.0c',					'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/583309cca153ab9fb55e60f5e0ce4cda58b1a3ab',			'DF6C21'],
			['0.2.0b',		'power',			'U-Credits, M-RPC More Descriptive, RFV-0.2.0b',					'https://github.com/UmbratheUmbreon/DenpaFunkinSource/commit/97101b422b7512d51cf38802a8167aed858ddff4',			'DF6C21'],

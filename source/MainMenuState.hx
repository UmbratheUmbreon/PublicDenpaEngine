...
{
	#if !debug
	public static var denpaEngineVersion:String = '0.5.0c'; //This is also used for Discord RPC
	#else
	public static var denpaEngineVersion:String = '0.5.0c Nightly'; //For declaring "HEY THIS ISNT FINAL"
	#end

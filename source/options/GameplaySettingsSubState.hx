...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Input System:',
			"What engine's input system do you want?",
			'inputType',
			'string',
			'Psych',
			['Psych']);
		...
		var option:Option = new Option('Random Mode',
			'Causes the notes to randomly swap on every play!',
			'randomMode',
			'bool',
			false);
		addOption(option);

		var option:Option = new Option('Ghost Mode',
			'Causes the notes to disappear after a certain distance!',
			'ghostMode',
			'bool',
			false);
		addOption(option);

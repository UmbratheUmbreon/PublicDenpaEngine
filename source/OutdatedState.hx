...
class OutdatedState extends MusicBeatState
{
	...
	override function create()
	{
		...
		buttonYes.animation.addByPrefix('idle', "yes", 12);
		...
		buttonNo.animation.addByPrefix('idle', "no", 12);
		...
		warning = new FlxSprite().loadGraphic(Paths.image('oscillators/warning'));
		warning.scale.set(8,8);
